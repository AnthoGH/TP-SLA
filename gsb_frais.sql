...
-- Généré le :  Jeu 05 Octobre 2017 à 11:22
...
CREATE TABLE `Absence` (
  ...
  `refMotif` int(11) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `nbJours` decimal(10,2) DEFAULT NULL
...
('a17', '09', 0, '0.00', '2017-10-04', 'CL'),
('a17', '10', 0, '0.00', '2017-10-04', 'CR');
...
ALTER TABLE `Absence`
  ...
  ADD KEY `mois` (`mois`),
  ADD KEY `Absence_ibfk_1` (`idVisiteur`,`mois`),
...
--
ALTER TABLE `Absence`
  ADD CONSTRAINT `Absence_ibfk_1` FOREIGN KEY (`idVisiteur`,`mois`) REFERENCES `FicheFrais` (`idVisiteur`, `mois`),
  ADD CONSTRAINT `Absence_ibfk_2` FOREIGN KEY (`refMotif`) REFERENCES `Motif` (`code`);
